...
# --- Spec #66 §4.2: parse_change_head and net_change tests


def test_parse_change_head_and_net_change_round_trip():
    """Test parse_change_head and net_change with all verbs from describe_change."""
    old = "a\nb\n"
    ...
    for v in ("Wrote", "Edited", "Appended to", "Inserted into",
        ...
        # With actual changes
        result = tools.describe_change("f.txt", old, new, verb=v)
